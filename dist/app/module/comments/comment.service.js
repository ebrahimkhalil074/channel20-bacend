...
//     return result
// }
const createCommentFromDB = (newsId, videoId, anonymousId, content, verifiedUser) => __awaiter(void 0, void 0, void 0, function* () {
    let userId = null;
    ...
    const result = yield config_1.default.comment.create({
        data: {
...
const getAllCommentIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
